...
const routes = [
  ...
  { path: 'booking/rooms/class/add', exact: true, name: 'Add room', element: addRoomClass },
  { path: '/booking/rooms/add', exact: true, name: 'Add room', element: addRoom },
  {
  ...
  { path: '/booking/reservations/all', exact: true, name: 'All Reservation', element: Reservation },
  {
  ...
  { path: '/booking/user/add', exact: true, name: 'Add user', element: UserAdd },
  { path: '/booking/users', exact: true, name: 'User', element: Users },
  { path: '/booking/products/add', exact: true, name: 'Product', element: ProductsAdd },
  { path: '/booking/products/all', exact: true, name: 'Product', element: Products },
  { path: '/booking/services/add', exact: true, name: 'Service', element: ServicesAdd },
  { path: '/booking/services/all', exact: true, name: 'Service', element: Services },
]
